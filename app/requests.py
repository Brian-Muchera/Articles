...
# get_sources_url = base_url.format(base_url,' b8ae8be963f0453c8706fbc8fc966e77')
...
def get_sources():
	...
	with urllib.request.urlopen(base_url + 'b8ae8be963f0453c8706fbc8fc966e77') as url:
...
def get_articles():
	...
	with urllib.request.urlopen(articles_url + 'b8ae8be963f0453c8706fbc8fc966e77') as url:
